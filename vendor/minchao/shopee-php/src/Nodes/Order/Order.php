...
class Order extends NodeAbstract
{
     ...
     * @return ResponseData
     */
    public function getEscrowDetails($parameters = [])
    {
     ...
     * @return ResponseData
     */
    public function getEscrowReleasedOrders($parameters = [])
    {
     ...
     * @return ResponseData
     */
    public function getForderInfo($parameters = [])
    {
     ...
     * @return ResponseData
     */
    public function getOrdersByStatus($parameters = [])
    {
     ...
     * @return ResponseData
     */
    public function getOrdersList($parameters = []){
     ...
     * @return ResponseData
     */
    public function acceptBuyerCancellation($parameters = [])
    {
     ...
     * @return ResponseData
     */
    public function addOrderNote($parameters = [])
    {
     ...
     * @return ResponseData
     */
    public function cancelOrder($parameters = []){
     ...
     * @return ResponseData
     */
    public function rejectBuyerCancellation($parameters = [])
    {
     ...
     * @return ResponseData
     */
    public function splitOrder($parameters = [])
    {
     ...
     * @return ResponseData
     */
    public function undoSplitOrder($parameters = [])
    {
