...
class ShopCategory extends NodeAbstract
{
     ...
     * @return ResponseData
     */
    public function addShopCategory($parameters = [])
    {
     ...
     * @return ResponseData
     */
    public function getShopCategories($parameters = [])
    {
     ...
     * @return ResponseData
     */
    public function deleteShopCategory($parameters = [])
    {
     ...
     * @return ResponseData
     */
    public function updateShopCategory($parameters = [])
    {
     ...
     * @return ResponseData
     */
    public function addItems($parameters = [])
    {
     ...
     * @return ResponseData
     */
    public function deleteItems($parameters = [])
    {
