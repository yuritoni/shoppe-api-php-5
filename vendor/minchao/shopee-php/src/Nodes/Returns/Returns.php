...
class Returns extends NodeAbstract
{
     ...
     * @return ResponseData
     */
    public function confirmReturn($parameters = [])
    {
     ...
     * @return ResponseData
     */
    public function disputeReturn($parameters = [])
    {
     ...
     * @return ResponseData
     */
    public function getReturnList($parameters = [])
    {
     ...
     * @return ResponseData
     */
    public function getReturnDetail($parameters = [])
    {
